                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="vertical-align: top;">
                                                <select class="form-control" name="kategori_pengeluaran" id="" required>
                                            ...
                                            <td style="vertical-align: top;">
                                            <select class="form-control" name="jenis_pengeluaran" id="" required>
                                            ...
                                            <td style="vertical-align: top;">
                                                <input type="text" name="harga_biaya" class="form-control" placeholder="Masukkan Harga " id="harga_dasar" required><br>
                                            </td>
                                            <td style="vertical-align: top;">
                                                <input type="text" name="total"  class="form-control" placeholder="Harga Total" id="harga_total" required><br>
                                            </td>
                                        </tr>
                                        <tr>
                                        </tr>
